        ...
        <div className='py-2 h-100 d-flex flex-column'>
            ...
            <ul className={styles.panelMenu}>
                ...
                }
                {
                    user?.role !== 'applicant' &&
                    <li>
                        <Link to="/dashboard/jobs" className={`${styles.btn} ${activeMenu === 'jobs' ? `${styles.active}` : ''}`}>
                ...
                }
                {
                    user?.role !== 'applicant' &&
                    <li>
                        <Link to="/dashboard/usermanagement" className={`${styles.btn} ${activeMenu === 'usermanagement' ? `${styles.active}` : ''}`}>
                            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                }
                {
                    ...
                    <li>
                        <Link to="/dashboard/companymanagement" className={`${styles.btn} ${activeMenu === 'companies' ? `${styles.active}` : ''}`}>
                            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                }
                {
                    ...
                    <li>
                        <Link to="/dashboard/mycompany" className={`${styles.btn} ${activeMenu === 'mycompany' ? `${styles.active}` : ''}`}>
                            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 4h12M6 4v16M6 4H5m13 0v16m0-16h1m-1 16H6m12 0h1M6 20H5M9 7h1v1H9V7Zm5 0h1v1h-1V7Zm-5 4h1v1H9v-1Zm5 0h1v1h-1v-1Zm-3 4h2a1 1 0 0 1 1 1v4h-4v-4a1 1 0 0 1 1-1Z"/>
                            </svg>
                            My Company
                ...
                <li>
                    <Link to="/dashboard/applied-jobs" className={`${styles.btn} ${activeMenu === 'appliedjobs' ? `${styles.active}` : ''}`}>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7H5a2 2 0 0 0-2 2v4m5-6h8M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m0 0h3a2 2 0 0 1 2 2v4m0 0v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-6m18 0s-4 2-9 2-9-2-9-2m9-2h.01"/>
                        </svg>
                        Applied Jobs
                ...
                <li>
                    <Link to="/dashboard/myprofile" className={`${styles.btn} ${activeMenu === 'myprofile' ? `${styles.active}` : ''}`}>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className='px-2'>
                <button className='btn btn-danger w-100' onClick={() => dispatch(logoutUser())}>Logout</button>
            </div>
        </div>
    )
}
