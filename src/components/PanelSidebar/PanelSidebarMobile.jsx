...
import styles from './PanelSidebarMobile.module.css'
import { useSelector } from 'react-redux'
import { logoutUser } from '../../utils/userSlice';

const PanelSidebarMobile = ({ activeMenu = 'overview' }) => {
    const user = useSelector((state) => state.user.data);
    return (
        <div className={`${styles.wrapper} d-flex flex-column shadow`}>
            ...
            <div className='px-2'>
                <button className='btn btn-danger w-100 p-0 py-2' onClick={() => dispatch(logoutUser())} aria-label='logout'>
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
